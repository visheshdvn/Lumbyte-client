      ...
      <div className="container mx-auto horizontal-spacing xl:pt-8 lg:pt-6 md:pt-4 pt-5">
        ...
        <section className="grid gap-1 grid-cols-12 mb-5">
          <div className="col-span-1 flex lg:flex-col items-center order-2 lg:order-1 pt-2 lg:pt-0">
            ...
            <ul className="flex lg:block pt-2 lg:sticky lg:top-36">
              <li className="lg:mb-8 mr-5 lg:mr-0">
                <TwitterShareButton
                  title={title}
          ...
          <div className="lg:col-span-8 col-span-12 order-1 lg:order-2">
            <main key={id} className="pr-0 xl:pr-12 lg:pr-8">
              ...
              {/* author data */}
              <div className="flex py-3 border-t-4 border-b-4 border-grayMain dark:border-gray-400">
                <div className="flex items-center">
                  <div className="rounded-full lg:h-36 lg:w-36 h-24 w-24 relative overflow-hidden bg-yellow-75">
                    <a
                      href="https://www.linkedin.com/in/visheshdvn"
                      target="_blank"
                    >
                      <Image
                        ...
                        layout="fill"
                        className="object-cover object-center transform transition-all duration-1000 hover:scale-110 cursor-pointer"
                        placeholder="blur"
                        blurDataURL={dp.url}
                      />
                    </a>
                ...
                <div className="flex-1 px-4 py-3">
                  <a
                    ...
                    rel="noreferrer"
                  >
                    <h1 className="lg:text-4xl text-3xl font-raleway font-black leading-8 rounded-md">
                      {firstname} {lastname}
                    </h1>
        ...
        <section className="py-3 mb-14">
          <div className="container mx-auto horizontal-spacing">
            <h1 className="wide-head xl:mt-18 lg:mt-18 mt-16">
              Read more
            </h1>
...
function SimilarArticles({ data }) {
  ...
  return (
    ...
    >
      <div className="scale-parent relative h-44 sm:h-64 md:h-72 w-full rounded-md overflow-hidden">
        <div
          style={{
            backgroundImage:
        ...
        <Image
          className="object-cover object-center duration-1000 transition-all"
          src={getValidImageURL(banner.url)}
          alt={banner.alternativeText}
          layout="fill"
          placeholder="blur"
        ...
        <h3 className="absolute bottom-2 right-2 left-2 font-raleway font-black text-white text-2xl sm:text-2xl lg:text-3xl leading-7 z-20 pointer-events-none">
          {title}
        </h3>
      </div>
    </a>
