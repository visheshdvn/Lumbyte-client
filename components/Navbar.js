          ...
          <>
            <div className="container horizontal-spacing mx-auto">
              <div className="relative flex items-center justify-between h-auto">
                ...
                <div className="flex-1 flex items-center justify-center md:items-stretch">
                  ...
                  <Link href="/">
                    <a className="font-antonio tracking-custom lg:-my-1 xl:text-4.75xl md:text-4.5xl">
                      LUMBYTES
                    </a>
                  </Link>
                  {/* </div> */}
            ...
            <div className="bg-grayMain">
              <div className="container mx-auto horizontal-spacing flex">
                <div className="md:block py-2 flex-1 items-center">
                  <div className="w-min border-r border-whiteMain-50">
                    <SecondaryNavLink href="/">WEB</SecondaryNavLink>
                    <SecondaryNavLink href="/">BLOCKCHAIN</SecondaryNavLink>
                    <SecondaryNavLink href="/topic/code">CODE</SecondaryNavLink>
                  </div>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  >
                    ...
                    <div className="absolute">
                      <div style={{paddingBottom: "2px"}} className="text-xl">{enabled ? "🌞" : "🌒"}</div>
                    </div>
                  </Switch>
